...
class DataForm(forms.Form):
    ...
    d_i_m = forms.FloatField(label='Внешний диаметр НКТ, мм:', initial=142)
    d_o_m = forms.FloatField(label='Внутренний диаметр ЭК, мм:', initial=73)
    ...
    t_head = forms.FloatField(label='Температура на устье скважины, С:', initial=37)
    wct = forms.FloatField(label='Обводненность продукции, дол.ед:', initial=0.4)
